...
import com.maoxingren.BuildConfig;
import com.maoxingren.devmanager.TaroDevManager;
import com.maoxingren.devmanager.TaroReactNativeHost;
import com.maoxingren.newarchitecture.MainApplicationReactNativeHost;
  ...
  private static void initializeFlipper(
    ...
    if (BuildConfig.DEBUG) {
      try {
        ...
        */
        Class<?> aClass = Class.forName("com.maoxingren.ReactNativeFlipper");
        aClass
